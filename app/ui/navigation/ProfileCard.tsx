...
export default function ProfileCard({
    ...
    return (
        <div className={clsx(
            "flex flex-col items-center justify-start rounded-md min-w-32 max-w-32 absolute top-[160%] left-1/2 -translate-x-1/2 transition-all ease-in-out text-text bg-secondary border-2 border-slate-500 z-50",
            {
